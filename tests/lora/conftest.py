...
def dist_init():
    ...
    if current_platform.is_cpu() or current_platform.is_tpu():
        backend = 'gloo'
    init_distributed_environment(world_size=1, rank=0, distributed_init_method=f'file://{temp_file}', local_rank=0, backend=backend)
...
def llama_2_7b_model_extra_embeddings(llama_2_7b_engine_extra_embeddings):
    yield llama_2_7b_engine_extra_embeddings.model_executor.driver_worker.model_runner.model
