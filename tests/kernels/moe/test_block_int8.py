...
def test_w8a8_block_int8_fused_moe(M, N, K, E, topk, block_size, dtype, seed):
    ...
    _, w1, w1_s, _, w2, w2_s = make_test_weights(E, N, K, dtype, torch.int8, per_act_token_quant=False, block_shape=block_size)
    with set_current_vllm_config(vllm_config):
        out = fused_moe(a, w1, w2, score, topk, renormalize=False, use_int8_w8a8=True, w1_scale=w1_s, w2_scale=w2_s, block_shape=block_size)
        ref_out = torch_w8a8_block_int8_moe(a, w1, w2, w1_s, w2_s, score, topk, block_size)
