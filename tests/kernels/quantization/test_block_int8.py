...
from vllm.model_executor.layers.quantization.utils.int8_utils import w8a8_block_int8_matmul
...
@pytest.mark.parametrize('M,N,K,block_size,out_dtype,seed', itertools.product(M, N, K, BLOCK_SIZE, DTYPES, SEEDS))
