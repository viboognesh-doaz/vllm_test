...
from vllm.model_executor.layers.quantization.utils.fp8_utils import get_col_major_tma_aligned_tensor, per_token_group_quant_fp8, w8a8_block_fp8_matmul
...
@pytest.mark.parametrize('num_tokens,d,dtype,group_size,seed', itertools.product(NUM_TOKENS, D, DTYPES, GROUP_SIZE, SEEDS))
...
@pytest.mark.parametrize('M,N,K,block_size,out_dtype,seed', itertools.product(M, N, K, BLOCK_SIZE, OUT_DTYPES, SEEDS))
@torch.inference_mode()
