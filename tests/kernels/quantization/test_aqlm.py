...
def test_aqlm_dequant_opcheck():
    codes = torch.randint(-32768, 32767, (22016, 512, 1), device='cuda', dtype=torch.int16)
...
def test_aqlm_gemm_opcheck():
    ...
    codes = torch.randint(-32768, 32767, (12288, 512, 1), device='cuda', dtype=torch.int16)
    ...
    bias = None
    opcheck(torch.ops._C.aqlm_gemm, (input, codes, codebooks, scales, codebook_partition_sizes, None))
    opcheck(torch.ops._C.aqlm_gemm, (input, codes, codebooks, scales, codebook_partition_sizes, bias))