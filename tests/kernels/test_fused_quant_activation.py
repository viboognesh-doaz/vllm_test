...
NUM_TOKENS = [1, 17, 86, 1234, 3045]
HIDDEN_SIZES = [16, 48, 128, 1562, 4096]
SEEDS = [0]
...
def test_silu_and_mul(num_tokens: int, hidden_size: int, dtype: torch.dtype, quant_dtype: torch.dtype, seed: int, device: str) -> None:
