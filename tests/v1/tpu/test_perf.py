...
def test_perf(vllm_runner: type[VllmRunner], monkeypatch: pytest.MonkeyPatch, params: TestParams) -> None:
    ...
    with monkeypatch.context() as m:
        ...
        with vllm_runner(params.model, max_num_batched_tokens=MAX_MODEL_LEN, max_model_len=MAX_MODEL_LEN, max_num_seqs=MAX_NUM_SEQS, gpu_memory_utilization=GPU_UTIL, enforce_eager=False, tensor_parallel_size=1) as vllm_model:
