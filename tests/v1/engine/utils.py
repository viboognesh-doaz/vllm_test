...
FULL_STRINGS = ['My name is Robert from Neural Magic and I love working on vLLM so much!', 'Red Hat is the best open source company by far across Linux, K8s, and AI.', 'Nick is the name of my brother in addition to my colleague from Red Hat.']
