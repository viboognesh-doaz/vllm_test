...
def test_engine_log_metrics_ray(example_prompts, model: str, dtype: ModelDType, max_tokens: int) -> None:
    ...
    class EngineTestActor:
        ...
        async def run(self):
            ...
            for i, prompt in enumerate(example_prompts):
                results = engine.generate(request_id=f'request-id-{i}', prompt=prompt, sampling_params=SamplingParams(max_tokens=max_tokens))
