...
SIMPLE_PROMPT = ('The best part about working on vLLM is that I got to meet so many people across various different organizations like UCB, Google, and Meta which means',)
...
def test_accuracy():
    ...
    run_simple_prompt()
    model_args = f'model={MODEL_NAME},base_url={BASE_URL}/completions,num_concurrent={NUM_CONCURRENT},tokenized_requests=False'
