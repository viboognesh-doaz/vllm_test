...
model_config = {'bigcode/starcoder2-3b': TestConfig(4096, (800, 1100)), 'google/gemma-3-1b-it': TestConfig(4096, (400, 800))}

@pytest.mark.parametrize('model', ['bigcode/starcoder2-3b', 'google/gemma-3-1b-it'])
