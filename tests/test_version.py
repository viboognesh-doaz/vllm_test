...
@pytest.mark.parametrize('version_tuple, version_str, expected', [((0, 0, 'dev'), '0.0', True), ((0, 0, 'dev'), 'foobar', True), ((0, 7, 4), '0.6', True), ((0, 7, 4), '0.5', False), ((0, 7, 4), '0.7', False), ((1, 2, 3), '1.1', True), ((1, 2, 3), '1.0', False), ((1, 2, 3), '1.2', False), ((1, 0, 0), '1.-1', True), ((1, 0, 0), '0.9', False), ((1, 0, 0), '0.17', False)])
