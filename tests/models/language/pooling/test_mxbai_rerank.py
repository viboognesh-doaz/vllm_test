...
RERANK_MODELS = [RerankModelInfo('mixedbread-ai/mxbai-rerank-base-v2', architecture='Qwen2ForSequenceClassification', enable_test=True), RerankModelInfo('mixedbread-ai/mxbai-rerank-large-v2', architecture='Qwen2ForSequenceClassification', enable_test=False)]
...
def test_rerank_models_mteb(vllm_runner, model_info: RerankModelInfo) -> None:
    ...
    if model_info.architecture == 'Qwen2ForSequenceClassification':
        vllm_extra_kwargs['hf_overrides'] = {'architectures': ['Qwen2ForSequenceClassification'], 'classifier_from_token': ['0', '1'], 'method': 'from_2_way_softmax'}
    mteb_test_rerank_models(MxbaiRerankerHfRunner, vllm_runner, model_info, vllm_extra_kwargs)