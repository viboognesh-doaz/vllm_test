...
@pytest.mark.parametrize('num_tokens,d,dtype', [(7, 512, torch.half), (7, 512, torch.float), (83, 512, torch.half)])
@torch.inference_mode()
def test_act_and_mul(activation: str, num_tokens: int, d: int, dtype: torch.dtype) -> None:
