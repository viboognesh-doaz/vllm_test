...
def test_eagle():
    patched_draft_path = patch_eagle_draft_with_lm_head(target_model_id='meta-llama/Llama-2-7b-hf', draft_model_id='yuhuili/EAGLE-llama2-chat-7B')
    llm = LLM(model='meta-llama/Llama-2-7b-hf', speculative_config={'model': patched_draft_path, 'num_speculative_tokens': 5, 'max_model_len': 128}, max_num_seqs=1, max_model_len=128, tensor_parallel_size=2, override_neuron_config={'enable_eagle_speculation': True, 'enable_fused_speculation': True, 'fused_qkv': True})
