...
from vllm.model_executor.model_loader.tensorizer import TensorizerConfig, tensorize_lora_adapter, tensorize_vllm_model
import gc
import openai
import os
import pytest
...
def server(model_uri, tensorize_model_and_lora):
    args = ['--load-format', 'tensorizer', '--served-model-name', MODEL_NAME, '--enable-lora']
