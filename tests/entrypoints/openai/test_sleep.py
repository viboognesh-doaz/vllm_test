...
def test_sleep_mode():
    args = ['--dtype', 'bfloat16', '--max-model-len', '8192', '--max-num-seqs', '128', '--enable-sleep-mode']
    with RemoteOpenAIServer(MODEL_NAME, args, env_dict={'VLLM_SERVER_DEV_MODE': '1', 'CUDA_VISIBLE_DEVICES': '0'}) as remote_server:
