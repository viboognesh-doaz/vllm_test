...
def test_streaming_tool_call_with_large_steps():
    mock_tokenizer = MagicMock()
    tool_parser: ToolParser = ToolParserManager.get_tool_parser('pythonic')(mock_tokenizer)
    model_output_deltas = ["[get_weather(city='San", f" Francisco', metric='celsius'), {PARAMETERLESS_FUNCTION_OUTPUT}, {EMPTY_LIST_FUNCTION_OUTPUT}]"]
...
def test_regex_timeout_handling(streaming: bool):
    ...
    mock_tokenizer = MagicMock()
    tool_parser: ToolParser = ToolParserManager.get_tool_parser('llama4_pythonic')(mock_tokenizer)
