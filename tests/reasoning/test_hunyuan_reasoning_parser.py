...
START_RESPONSE = '\n</think>\n<answer>\n'
END_RESPONSE = '\n</answer>'
NO_REASONING_QUICK_THROUGHT = {'output': f'{START_REASONING}{START_RESPONSE}This is the rest{END_RESPONSE}', 'reasoning_content': None, 'content': 'This is the rest'}
SIMPLE_REASONING = {'output': f'{START_REASONING}This is a reasoning section{START_RESPONSE}This is the rest{END_RESPONSE}', 'reasoning_content': 'This is a reasoning section', 'content': 'This is the rest'}
...
COMPLETE_REASONING_WITH_SYMBOL = {'output': f'{START_REASONING}This is a reasoning section!{START_RESPONSE}', 'reasoning_content': 'This is a reasoning section!', 'content': None}
