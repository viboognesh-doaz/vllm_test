...
def subscriber(publisher_config):
    ...
    sub = MockSubscriber([endpoint], [replay_endpoint] if replay_endpoint else None, publisher_config.topic)
    yield sub
    sub.close()
...
class MockSubscriber:
    ...
    def __init__(self, pub_endpoints: Union[str, list[str]], replay_endpoints: Optional[Union[str, list[str]]]=None, topic: str='', decode_type=SampleBatch):
