    ...
    for scalar_type, dtype in itertools.product(SCALAR_TYPES, DTYPES):
        ...
        for group_blocks, m_blocks, thread_configs in itertools.product(GROUP_BLOCKS, THREAD_M_BLOCKS, THREAD_CONFIGS):
            ...
            for is_zp_float in is_zp_float_list:
                template_str = jinja2.Template(TEMPLATE).render(scalar_t=c_dtype, w_type_id=scalar_type + '.id()', threads=threads, thread_m_blocks=max(m_blocks, 1), thread_n_blocks=n_blocks, thread_k_blocks=k_blocks, m_block_size_8=m_blocks == 0.5, stages='pipe_stages', group_blocks=group_blocks, is_zp_float=is_zp_float)
