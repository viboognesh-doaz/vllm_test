...
@triton.testing.perf_report(triton.testing.Benchmark(x_names=['batch_size'], x_vals=[1, 16, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384], x_log=False, line_arg='provider', line_vals=_enabled, line_names=_enabled, ylabel='TFLOP/s (larger is better)', plot_name='BF16 vs FP8 GEMMs', args={}))
...
if __name__ == '__main__':
    ...
    for K, N, model in prepare_shapes(args):
        ...
        benchmark.run(print_data=True, show_plots=True, save_path=f'bench_fp8_res_n{N}_k{K}', N=N, K=K)
