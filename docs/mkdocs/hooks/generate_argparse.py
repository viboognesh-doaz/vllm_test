...
def create_serve_parser() -> FlexibleArgumentParser:
    ...
    parser = FlexibleArgumentParser()
    parser.formatter_class = lambda prog: MarkdownFormatter(prog, starting_heading_level=4)
...
def on_startup(command: Literal['build', 'gh-deploy', 'serve'], dirty: bool):
    ...
    parsers = {'engine_args': create_parser(EngineArgs), 'async_engine_args': create_parser(AsyncEngineArgs, async_args_only=True), 'serve': create_serve_parser()}
