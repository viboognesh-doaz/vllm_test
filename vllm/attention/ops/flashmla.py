...
def is_flashmla_supported() -> Tuple[bool, Optional[str]]:
    ...
    if not _flashmla_C_AVAILABLE:
        return (False, 'vllm._flashmla_C is not available, likely was not compiled due to insufficient nvcc version or a supported arch (only sm90a currently) was not in the list of target arches to compile for.')
    return (True, None)
