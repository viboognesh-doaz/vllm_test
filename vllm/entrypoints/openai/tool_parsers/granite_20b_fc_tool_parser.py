...
from vllm.entrypoints.openai.tool_parsers.utils import consume_space, find_common_prefix, is_complete_json, partial_json_loads
...
class Granite20bFCToolParser(ToolParser):
    ...
    def __init__(self, tokenizer: AnyTokenizer):
        ...
        self.tool_call_regex = re.compile('<function_call>\\s*')
