...
class KimiK2ToolParser(ToolParser):
    ...
    def __init__(self, tokenizer: AnyTokenizer):
        ...
        self.tool_call_regex = re.compile('<\\|tool_call_begin\\|>\\s*(?P<tool_call_id>[\\w\\.]+:\\d+)\\s*<\\|tool_call_argument_begin\\|>\\s*(?P<function_arguments>.*?)\\s*<\\|tool_call_end\\|>')
        self.stream_tool_call_portion_regex = re.compile('(?P<tool_call_id>[\\w\\.]+:\\d+)\\s*<\\|tool_call_argument_begin\\|>\\s*(?P<function_arguments>.*)')
        self.stream_tool_call_name_regex = re.compile('(?P<tool_call_id>[\\w\\.]+:\\d+)\\s*')
        ...
        if self.tool_calls_start_token not in model_output:
            ...
            try:
                ...
                for match in function_call_tuples:
                    ...
                    tool_calls.append(ToolCall(id=function_id, type='function', function=FunctionCall(name=function_name, arguments=function_args)))
