...
def start_monitoring_torch_compile(vllm_config: VllmConfig):
    ...
    if compilation_config.level == CompilationLevel.PIECEWISE and compilation_config.debug_dump_path:
        path = os.path.join(compilation_config.debug_dump_path, f'rank_{vllm_config.parallel_config.rank}')
