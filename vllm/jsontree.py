...
_T = TypeVar('_T')
_U = TypeVar('_U')
JSONTree = Union[dict[str, 'JSONTree[_T]'], list['JSONTree[_T]'], tuple['JSONTree[_T]', ...], _T]
...
@overload
def json_reduce_leaves(func: Callable[[_U, _T], _U], value: JSONTree[_T], initial: _U, /) -> _U:
    ...

def json_reduce_leaves(func: Callable[..., Union[_T, _U]], value: JSONTree[_T], initial: _U=..., /) -> Union[_T, _U]:
    """
