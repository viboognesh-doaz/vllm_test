...
class IterationStats:
    ...
    def update_from_output(self, output: 'EngineCoreOutput', engine_core_timestamp: float, is_prefilling: bool, prompt_len: int, req_stats: RequestStateStats, lora_stats: Optional[LoRAStats]):
    ...
    def update_from_events(self, req_id: str, events: list['EngineCoreEvent'], is_prefilling: bool, req_stats: RequestStateStats, lora_stats: Optional[LoRAStats]):
        for event in events:
