...
from vllm.v1.structured_output.backend_types import StructuredOutputGrammar, StructuredOutputKey, StructuredOutputOptions
import dataclasses
import functools
import json
...
class StructuredOutputRequest:
    ...
    _grammar: Optional[Union[Future[StructuredOutputGrammar], StructuredOutputGrammar]] = None
    ...
    def grammar(self) -> Optional[StructuredOutputGrammar]:
        ...
        return cast(Optional[StructuredOutputGrammar], self._grammar) if completed else None

    @grammar.setter
    def grammar(self, grammar: Union[StructuredOutputGrammar, Future[StructuredOutputGrammar]]) -> None:
