...
from vllm.distributed.kv_events import AllBlocksCleared, BlockRemoved, BlockStored, KVCacheEvent
from vllm.logger import init_logger
from vllm.v1.core.kv_cache_utils import BlockHash, BlockHashWithGroupId, FreeKVCacheBlockQueue, KVCacheBlock, generate_block_hash_extra_keys, hash_block_tokens
...
class BlockPool:
    ...
    def reset_prefix_cache(self) -> bool:
        ...
        if num_used_blocks != 1:
            logger.warning('Failed to reset prefix cache because some blocks (%d) are not freed yet', num_used_blocks - 1)
            return False
