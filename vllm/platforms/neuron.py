...
class NeuronPlatform(Platform):
    ...
    def get_device_communicator_cls(cls) -> str:
        if envs.VLLM_USE_V1:
            return 'vllm.distributed.device_communicators.neuron_communicator.NeuronCommunicator'
        else:
    ...
    def get_neuron_framework_to_use(self):
        ...
        if specified_framework == nxd_framework and nxd_installed or (specified_framework is None and nxd_installed):
