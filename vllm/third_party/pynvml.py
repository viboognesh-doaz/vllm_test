...
NVML_PCIE_ATOMICS_CAP_FETCHADD32 = 1
NVML_PCIE_ATOMICS_CAP_FETCHADD64 = 2
NVML_PCIE_ATOMICS_CAP_SWAP32 = 4
NVML_PCIE_ATOMICS_CAP_SWAP64 = 8
NVML_PCIE_ATOMICS_CAP_CAS32 = 16
NVML_PCIE_ATOMICS_CAP_CAS64 = 32
NVML_PCIE_ATOMICS_CAP_CAS128 = 64
...
NVML_FI_PWR_SMOOTHING_HW_CIRCUITRY_PERCENT_LIFETIME_REMAINING = 258
...
NVML_FI_MAX = 269
NVML_NVLINK_STATE_INACTIVE = 0
NVML_NVLINK_STATE_ACTIVE = 1
NVML_NVLINK_STATE_SLEEP = 2
...
class nvmlPciInfoExt_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('domain', c_uint), ('bus', c_uint), ('device', c_uint), ('pciDeviceId', c_uint), ('pciSubSystemId', c_uint), ('baseClass', c_uint), ('subClass', c_uint), ('busId', c_char * NVML_DEVICE_PCI_BUS_ID_BUFFER_SIZE)]
    _fmt_ = {'version': '0x%04X', 'domain': '0x%04X', 'bus': '0x%02X', 'device': '0x%02X', 'pciDeviceId': '0x%08X', 'pciSubSystemId': '0x%08X', 'baseClass': '0x%01X', 'subClass': '0x%01X'}
nvmlPciInfoExt_v1 = 16777280
...
class c_nvmlSystemDriverBranchInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('branch', c_char * NVML_SYSTEM_DRIVER_VERSION_BUFFER_SIZE)]
SystemDriverBranchInfo_v1 = 16777300
...
class nvmlClkMonStatus_t(Structure):
    _fields_ = [('bGlobalStatus', c_uint), ('clkMonListSize', c_uint), ('clkMonList', nvmlClkMonFaultInfo_t * MAX_CLK_DOMAINS)]
...
nvmlProcessDetailList_v1 = 16777240
...
class c_nvmlValue_t(Union):
    _fields_ = [('dVal', c_double), ('uiVal', c_uint), ('ulVal', c_ulong), ('ullVal', c_ulonglong), ('sllVal', c_longlong), ('siVal', c_int), ('usVal', c_ushort)]
...
nvmlNvlinkSupportedBwModes_v1 = 16777244

class c_nvmlNvlinkSupportedBwModes_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('bwModes', c_uint8 * NVML_NVLINK_TOTAL_SUPPORTED_BW_MODES), ('totalBwModes', c_uint8)]

    def __init__(self):
        super(c_nvmlNvlinkSupportedBwModes_v1_t, self).__init__(version=nvmlNvlinkSupportedBwModes_v1)
nvmlNvlinkGetBwMode_v1 = 16777228
...
nvmlNvlinkSetBwMode_v1 = 16777228
...
class c_nvmlVgpuHeterogeneousMode_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('mode', c_uint)]
VgpuHeterogeneousMode_v1 = 16777224

class c_nvmlVgpuPlacementId_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('placementId', c_uint)]
VgpuPlacementId_v1 = 16777224

class c_nvmlVgpuPlacementList_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('count', c_uint), ('placementSize', c_uint), ('placementIds', POINTER(c_uint))]
VgpuPlacementList_v1 = 16777240
...
class c_nvmlVgpuPlacementList_v2_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('placementSize', c_uint), ('count', c_uint), ('placementIds', POINTER(c_uint)), ('mode', c_uint)]
VgpuPlacementList_v2 = 33554464

class c_nvmlVgpuTypeBar1Info_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('bar1Size', c_ulonglong)]
VgpuTypeBar1Info_v1 = 16777232
...
class c_nvmlVgpuInstanceUtilizationInfo_v1_t(_PrintableStructure):
    _fields_ = [('timeStamp', c_ulonglong), ('vgpuInstance', _nvmlVgpuInstance_t), ('smUtil', c_nvmlValue_t), ('memUtil', c_nvmlValue_t), ('encUtil', c_nvmlValue_t), ('decUtil', c_nvmlValue_t), ('jpgUtil', c_nvmlValue_t), ('ofaUtil', c_nvmlValue_t)]

class c_nvmlVgpuInstancesUtilizationInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('sampleValType', _nvmlValueType_t), ('vgpuInstanceCount', c_uint), ('lastSeenTimeStamp', c_ulonglong), ('vgpuUtilArray', POINTER(c_nvmlVgpuInstanceUtilizationInfo_v1_t))]
VgpuInstancesUtilizationInfo_v1 = 16777248
...
class c_nvmlVgpuProcessUtilizationInfo_v1_t(_PrintableStructure):
    _fields_ = [('processName', c_char * NVML_VGPU_NAME_BUFFER_SIZE), ('timeStamp', c_ulonglong), ('vgpuInstance', _nvmlVgpuInstance_t), ('pid', c_uint), ('smUtil', c_uint), ('memUtil', c_uint), ('encUtil', c_uint), ('decUtil', c_uint), ('jpgUtil', c_uint), ('ofaUtil', c_uint)]

class c_nvmlVgpuProcessesUtilizationInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('vgpuProcessCount', c_uint), ('lastSeenTimeStamp', c_ulonglong), ('vgpuProcUtilArray', POINTER(c_nvmlVgpuProcessUtilizationInfo_v1_t))]
VgpuProcessesUtilizationInfo_v1 = 16777240

class nvmlVgpuRuntimeState_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('size', c_ulonglong)]
VgpuRuntimeState_v1 = 16777232
...
class c_nvmlProcessUtilizationInfo_v1_t(_PrintableStructure):
    _fields_ = [('timeStamp', c_ulonglong), ('pid', c_uint), ('smUtil', c_uint), ('memUtil', c_uint), ('encUtil', c_uint), ('decUtil', c_uint), ('jpgUtil', c_uint), ('ofaUtil', c_uint)]

class c_nvmlProcessesUtilizationInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('processSamplesCount', c_uint), ('lastSeenTimeStamp', c_ulonglong), ('procUtilArray', POINTER(c_nvmlProcessUtilizationInfo_v1_t))]
ProcessesUtilizationInfo_v1 = 16777240
...
class c_nvmlMarginTemperature_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('marginTemperature', c_int)]
nvmlMarginTemperature_v1 = 16777224
...
nvmlEventTypeSingleBitEccErrorStorm = 512
nvmlEventTypeDramRetirementEvent = 1024
nvmlEventTypeDramRetirementFailure = 2048
nvmlEventTypeNonFatalPoisonError = 4096
nvmlEventTypeFatalPoisonError = 8192
nvmlEventTypeGpuUnavailableError = 16384
nvmlEventTypeGpuRecoveryAction = 32768
nvmlEventTypeNone = 0
nvmlEventTypeAll = nvmlEventTypeNone | nvmlEventTypeSingleBitEccError | nvmlEventTypeDoubleBitEccError | nvmlEventTypePState | nvmlEventTypeClock | nvmlEventTypePowerSourceChange | nvmlEventTypeXidCriticalError | nvmlEventMigConfigChange | nvmlEventTypeSingleBitEccErrorStorm | nvmlEventTypeDramRetirementEvent | nvmlEventTypeDramRetirementFailure | nvmlEventTypeNonFatalPoisonError | nvmlEventTypeFatalPoisonError | nvmlEventTypeGpuUnavailableError | nvmlEventTypeGpuRecoveryAction
...
NVML_GPU_INSTANCE_PROFILE_1_SLICE_GFX = 10
NVML_GPU_INSTANCE_PROFILE_2_SLICE_GFX = 11
NVML_GPU_INSTANCE_PROFILE_4_SLICE_GFX = 12
NVML_GPU_INSTANCE_PROFILE_COUNT = 13
...
class c_nvmlCoolerInfo_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('index', c_uint), ('coolerControlType', _nvmlCoolerControl_t), ('coolerTarget', _nvmlCoolerTarget_t)]
nvmlCoolerInfo_v1 = 16777232
...
nvmlSystemConfComputeSettings_v1 = 16777236

class c_nvmlSystemConfComputeSettings_v1_t(Structure):
    _fields_ = [('version', c_uint), ('environment', c_uint), ('ccFeature', c_uint), ('devToolsMode', c_uint), ('multiGpuMode', c_uint)]
...
class c_nvmlConfComputeSetKeyRotationThresholdInfo_t(Structure):
    _fields_ = [('version', c_uint), ('maxAttackerAdvantage', c_ulong)]
ConfComputeSetKeyRotationThresholdInfo_v1 = 16777232

class c_nvmlConfComputeGetKeyRotationThresholdInfo_t(Structure):
    _fields_ = [('version', c_uint), ('attackerAdvantage', c_ulong)]
ConfComputeGetKeyRotationThresholdInfo_v1 = 16777232
...
def throwOnVersionMismatch(func):
    ...
    def wrapper(*args, **kwargs):
        try:
            ...
            raise NVMLLibraryMismatchError('Unversioned function called and the pyNVML version does not match the NVML lib version. Either use matching pyNVML and NVML lib versions or use a versioned function such as ' + func.__name__ + '_v2')
    return wrapper
...
class c_nvmlDevicePerfModes_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('str', c_char * NVML_PERF_MODES_BUFFER_SIZE)]
nvmlDevicePerfModes_v1 = 16779268
...
class c_nvmlDeviceCurrentClockFreqs_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('str', c_char * NVML_PERF_MODES_BUFFER_SIZE)]
nvmlDeviceCurrentClockFreqs_v1 = 16779268
...
class c_nvmlTemperature_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('sensorType', _nvmlTemperatureSensors_t), ('temperature', c_int)]
nvmlTemperature_v1 = 16777228
...
def nvmlGetVgpuVersion(supported=None, current=None):
    ...
    _nvmlCheckReturn(ret)
    return NVML_SUCCESS if isUserDefined else [(supported.minVersion, supported.maxVersion), (current.minVersion, current.maxVersion)]
...
class c_nvmlClockOffset_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('type', _nvmlClockType_t), ('pstate', _nvmlPstates_t), ('clockOffsetMHz', c_int), ('minClockOffsetMHz', c_int), ('maxClockOffsetMHz', c_int)]
nvmlClockOffset_v1 = 16777240
...
def nvmlGpmQueryIfStreamingEnabled(device):
    ...
    _nvmlCheckReturn(ret)
    return c_state.value
NVML_NVLINK_POWER_STATE_HIGH_SPEED = 0
NVML_NVLINK_POWER_STATE_LOW = 1
NVML_NVLINK_LOW_POWER_THRESHOLD_MIN = 1
NVML_NVLINK_LOW_POWER_THRESHOLD_MAX = 8191
NVML_NVLINK_LOW_POWER_THRESHOLD_RESET = 4294967295
...
class c_nvmlGpuFabricInfo_t(_PrintableStructure):
    _fields_ = [('clusterUuid', c_char * NVML_DEVICE_UUID_BUFFER_SIZE), ('status', _nvmlReturn_t), ('cliqueId', c_uint32), ('state', _nvmlGpuFabricState_t)]
...
NVML_GPU_FABRIC_HEALTH_MASK_WIDTH_DEGRADED_BW = 17
...
NVML_GPU_FABRIC_HEALTH_MASK_WIDTH_ROUTE_RECOVERY = 17
...
NVML_GPU_FABRIC_HEALTH_MASK_WIDTH_ROUTE_UNHEALTHY = 17
...
NVML_GPU_FABRIC_HEALTH_MASK_WIDTH_ACCESS_TIMEOUT_RECOVERY = 17
nvmlGpuFabricInfo_v2 = 33554468

class c_nvmlGpuFabricInfoV_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('clusterUuid', c_char * NVML_GPU_FABRIC_UUID_LEN), ('status', _nvmlReturn_t), ('cliqueId', c_uint32), ('state', _nvmlGpuFabricState_t), ('healthMask', c_uint32)]
...
nvmlDeviceCapabilities_v1 = 16777224

class c_nvmlDeviceCapabilities_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('capMask', c_uint)]
...
class c_nvmlPlatformInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('ibGuid', c_char * 16), ('rackGuid', c_char * 16), ('chassisPhysicalSlotNumber', c_char), ('computeSlotIndex', c_char), ('nodeIndex', c_char), ('peerType', c_char), ('moduleId', c_char)]

    def __init__(self):
        super(c_nvmlPlatformInfo_v1_t, self).__init__(version=nvmlPlatformInfo_v1)
nvmlPlatformInfo_v1 = 16777260
...
nvmlWorkloadPowerProfileInfo_v1 = 16777260

class c_nvmlWorkloadPowerProfileInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('profileId', c_uint), ('priority', c_uint), ('conflictingmask', c_nvmlMask255_t)]

    def __init__(self):
        super(c_nvmlWorkloadPowerProfileInfo_v1_t, self).__init__(version=nvmlWorkloadPowerProfileInfo_v1)
nvmlWorkloadPowerProfileProfilesInfo_v1 = 16788472

class c_nvmlWorkloadPowerProfileProfilesInfo_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('perfProfilesMask', c_nvmlMask255_t), ('perfProfile', c_nvmlWorkloadPowerProfileInfo_v1_t * NVML_WORKLOAD_POWER_MAX_PROFILES)]

    def __init__(self):
        super(c_nvmlWorkloadPowerProfileProfilesInfo_v1_t, self).__init__(version=nvmlWorkloadPowerProfileProfilesInfo_v1)
nvmlWorkloadPowerProfileCurrentProfiles_v1 = 16777316

class c_nvmlWorkloadPowerProfileCurrentProfiles_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('perfProfilesMask', c_nvmlMask255_t), ('requestedProfilesMask', c_nvmlMask255_t), ('enforcedProfilesMask', c_nvmlMask255_t)]

    def __init__(self):
        super(c_nvmlWorkloadPowerProfileCurrentProfiles_v1_t, self).__init__(version=nvmlWorkloadPowerProfileCurrentProfiles_v1)
nvmlWorkloadPowerProfileRequestedProfiles_v1 = 16777252

class c_nvmlWorkloadPowerProfileRequestedProfiles_v1_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('requestedProfilesMask', c_nvmlMask255_t)]
...
def nvmlDeviceSetNvlinkBwMode(device, setBwMode):
    ...
    _nvmlCheckReturn(ret)
    return NVML_SUCCESS
nvmlDramEncryptionInfo_v1 = 16777224

class c_nvmlDramEncryptionInfo_t(_PrintableStructure):
    _fields_ = [('version', c_uint), ('encryptionState', _nvmlEnableState_t)]
...
NVML_POWER_SMOOTHING_ADMIN_OVERRIDE_NOT_SET = 4294967295
