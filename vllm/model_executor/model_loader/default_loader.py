...
from vllm.model_executor.model_loader.weight_utils import download_safetensors_index_file_from_hf, download_weights_from_hf, fastsafetensors_weights_iterator, filter_duplicate_safetensors_files, filter_files_not_needed_for_inference, get_lock, np_cache_weights_iterator, pt_weights_iterator, safetensors_weights_iterator
...
class DefaultModelLoader(BaseModelLoader):
    ...
    def get_all_weights(self, model_config: ModelConfig, model: nn.Module) -> Generator[tuple[str, torch.Tensor], None, None]:
