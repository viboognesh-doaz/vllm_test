...
class MarlinConfig(QuantizationConfig):
    ...
    def __init__(self, group_size: int, lm_head_quantized: bool) -> None:
        super().__init__()
    ...
    def override_quantization_method(cls, hf_quant_cfg, user_quant) -> Optional[QuantizationMethods]:
        is_marlin_format = hf_quant_cfg.get('checkpoint_format') == 'marlin' or hf_quant_cfg.get('is_marlin_format', False)
