...
class GPTBigCodeAttention(nn.Module):
    ...
    def __init__(self, config: GPTBigCodeConfig, cache_config: Optional[CacheConfig]=None, quant_config: Optional[QuantizationConfig]=None, prefix: str=''):
        super().__init__()
        ...
        self.attn = Attention(self.num_heads, self.head_dim, scale=self.scale, num_kv_heads=self.num_kv_heads, cache_config=cache_config, quant_config=quant_config, prefix=f'{prefix}.attn')
...
class GPTBigCodeModel(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str=''):
        ...
        self.start_layer, self.end_layer, self.h = make_layers(config.num_hidden_layers, lambda prefix: GPTBigCodeBlock(config, cache_config, quant_config, prefix=prefix), prefix=f'{prefix}.h')
...
class GPTBigCodeForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str=''):
        ...
        if self.config.tie_word_embeddings:
            ...
            self.lm_head = ParallelLMHead(self.transformer.vocab_size, self.transformer.embed_dim, org_num_embeddings=self.config.vocab_size)
