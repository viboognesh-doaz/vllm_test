...
class DeepSeekMultiTokenPredictor(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str=''):
        ...
        self.layers = torch.nn.ModuleDict({str(idx): DeepSeekMultiTokenPredictorLayer(config, f'{prefix}.layers.{idx}', model_config=vllm_config.model_config, cache_config=vllm_config.cache_config, quant_config=vllm_config.quant_config) for idx in range(self.mtp_start_layer_idx, self.mtp_start_layer_idx + self.num_mtp_layers)})
