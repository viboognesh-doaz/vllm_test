...
from vllm.transformers_utils.configs import ChatGLMConfig, Cohere2Config, DbrxConfig, DeepseekVLV2Config, EAGLEConfig, Exaone4Config, ExaoneConfig, JAISConfig, KimiVLConfig, MedusaConfig, MiniMaxText01Config, MiniMaxVL01Config, MllamaConfig, MLPSpeculatorConfig, MPTConfig, NemotronConfig, NVLM_D_Config, OvisConfig, RWConfig, SkyworkR1VChatConfig, SolarConfig, Telechat2Config, UltravoxConfig
...
_CONFIG_REGISTRY: dict[str, type[PretrainedConfig]] = {'chatglm': ChatGLMConfig, 'cohere2': Cohere2Config, 'dbrx': DbrxConfig, 'deepseek_vl_v2': DeepseekVLV2Config, 'kimi_vl': KimiVLConfig, 'mpt': MPTConfig, 'RefinedWeb': RWConfig, 'RefinedWebModel': RWConfig, 'jais': JAISConfig, 'mlp_speculator': MLPSpeculatorConfig, 'medusa': MedusaConfig, 'eagle': EAGLEConfig, 'exaone': ExaoneConfig, 'exaone4': Exaone4Config, 'minimax_text_01': MiniMaxText01Config, 'minimax_vl_01': MiniMaxVL01Config, 'nemotron': NemotronConfig, 'NVLM_D': NVLM_D_Config, 'ovis': OvisConfig, 'solar': SolarConfig, 'skywork_chat': SkyworkR1VChatConfig, 'telechat': Telechat2Config, 'ultravox': UltravoxConfig, **_CONFIG_REGISTRY_OVERRIDE_HF}
...
def get_hf_file_to_dict(file_name: str, model: Union[str, Path], revision: Optional[str]='main'):
    ...
    if file_path is None:
        try:
            ...
            logger.warning("Cannot connect to Hugging Face Hub. Skipping file download for '%s':", file_name, exc_info=e)
            return None
...
@cache
def get_sentence_transformer_tokenizer_config(model: str, revision: Optional[str]='main'):
    """
